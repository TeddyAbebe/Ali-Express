      ...
      <div id="MainHeader" class="flex items-center w-full bg-white">
        ...
        >
          ...
          <NuxtLink to="/shoppingcart" class="flex items-center">
            ...
            >
              <span
                class="absolute flex items-center justify-center -right-[3px] top-0 bg-[#FF4646] h-[17px] min-w-[17px] text-xs text-white px-0.5 rounded-full z-10"
              >
                0
              </span>
